...
namespace ReleaseTools.UnitTests.InstallerManifestYaml
{
    public class InstallerManifestEntryGeneratorTests
    {
            ...
            InstallerManifestEntryGenerator sut)
        {
            ...
            extensionPackageNameGuesserMock
                ...
                .Returns("SparrowBrain_PlayNext_2_3_4.pext");
    ...
    PackageUrl: https://github.com/SparrowBrain/Playnite.PlayNext/releases/download/v2.3.4/SparrowBrain_PlayNext_2_3_4.pext
    Changelog:
      - Change 1
      - Change 22
      - Fix important!
