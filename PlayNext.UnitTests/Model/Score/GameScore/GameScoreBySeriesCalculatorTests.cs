...
namespace PlayNext.UnitTests.Model.Score.GameScore
{
	public class GameScoreBySeriesCalculatorTests
	{
		...
		[Theory]
		[AutoData]
		public void Calculate_TwoGamesHaveNoReleaseDatesAndOrderedByReleaseDate_GameWithReleaseDateIs100(
			Game[] games,
			...
			GameScoreBySeriesCalculator sut)
		{
			...
			foreach (var game in games)
			{
				...
				game.SeriesIds.Add(seriesAttributeScore.Key);
			}

			var gameWithReleaseDate = games.Last();
			gameWithReleaseDate.ReleaseDate = releaseDate;
